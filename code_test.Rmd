...
diagnose_varying_args(num = 3, id = option[1])
```
...
diagnose_varying_args(num = 3, id = option[2])
```
...
### Factorial design, only two arguments can be varied.

```{r factorial, echo=F, warning=FALSE}
...
```{r mediation_analysis, echo=F, warning=FALSE}
diagnose_varying_args(num = 1, id = option[5])
diagnose_varying_args(num = 2, id = option[5])
diagnose_varying_args(num = 3, id = option[5])
```

### Multi Arm design, only two arguments can be varied.

```{r multi_arm, echo=F, warning=FALSE}
diagnose_varying_args(num = 1, id = option[6])
diagnose_varying_args(num = 2, id = option[6])
```

### Pretest Posttest design

```{r pretest_posttest, echo=F, warning=FALSE}
diagnose_varying_args(num = 1, id = option[7])
diagnose_varying_args(num = 2, id = option[7])
diagnose_varying_args(num = 3, id = option[7])
```

### Process Tracing design

```{r process_tracing,echo=F, warning=FALSE}
diagnose_varying_args(num = 1, id = option[8])
diagnose_varying_args(num = 2, id = option[8])
diagnose_varying_args(num = 3, id = option[8])
```

### Randomized Response design

```{r randomized_response, echo=F, warning=FALSE}
diagnose_varying_args(num = 1, id = option[9])
diagnose_varying_args(num = 2, id = option[9])
diagnose_varying_args(num = 3, id = option[9])
```

### Regression Discontinuity design

```{r regression_discontinuity, echo=F, warning=FALSE}
diagnose_varying_args(num = 1, id = option[10])
diagnose_varying_args(num = 2, id = option[10])
diagnose_varying_args(num = 3, id = option[10])
```

### Spillover design
```{r spillover, echo=F, warning=FALSE}
diagnose_varying_args(num = 1, id = option[11])
diagnose_varying_args(num = 2, id = option[11])
diagnose_varying_args(num = 3, id = option[11])
```

### Two Arm Attrition design
```{r two_arm_attrition, echo=F, warning=FALSE}
diagnose_varying_args(num = 1, id = option[12])
diagnose_varying_args(num = 2, id = option[12])
diagnose_varying_args(num = 3, id = option[12])
```

### Two Arm Covariate design
```{r two_arm_covariate, echo=F, warning=FALSE}
diagnose_varying_args(num = 1, id = option[13])
diagnose_varying_args(num = 2, id = option[13])
diagnose_varying_args(num = 3, id = option[13])
```

### Two Arm design
```{r two_arme, cho=F, warning=FALSE}
diagnose_varying_args(num = 1, id = option[14])
diagnose_varying_args(num = 2, id = option[14])
diagnose_varying_args(num = 3, id = option[14])
```

### Two by Two design
```{r two_by_two,echo=F, warning=FALSE}
diagnose_varying_args(num = 1, id = option[15])
diagnose_varying_args(num = 2, id = option[15])
diagnose_varying_args(num = 3, id = option[15])
```
